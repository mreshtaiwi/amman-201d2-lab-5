...
function sumArray(sumArr) { //eslint-disable-line
 //sumation using for loop
var sumation = 0;
for (var i=0 ; i < testArray.length  ; i++) {
     sumation+=testArray[i];
}

//sumation using function
var total=0;
total += sum(sumArr[0],sumArr[1])[0] + sumArr[2];
var message = sumArr[0] + "," + sumArr[1] + "," + sumArr[2] + " was passed in as an array of numbers, and " + total + " is their sum.";
var result = [total,message];
return result;
}
